   ...
   if($select_products->rowCount() > 0){
      ...
      if($insert_products){
         if($image_size > 2000000){
            $message[] = 'Tamaño de la imagen es muy grande!';
         }else{
      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>Seleccione una categoria</option>
               ...
               <option value="electrinics">Electrodomesticos</option>
               <option value="hygiene">Higiene</option>
               <option value="paper">Papeleria</option>
               <option value="personal">productos personales</option>
         </select>
         </div>
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="Precio del producto">
         <input type="file" name="image" required class="box" accept="image/jpg, image/jpeg, image/png">
         </div>
      </div>
      <textarea name="details" class="box" required placeholder="Detalles del producto" cols="30" rows="10"></textarea>
      <input type="submit" class="btn" value="Crear producto" name="add_product">
   </form>
